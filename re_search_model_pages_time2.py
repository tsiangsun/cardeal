#   execfile('re_search_model_pages_time2.py')
import re
import urllib
import urllib2
import math
...
#url = 'https://sfbay.craigslist.org/search/cto?s=720&hasPic=1&max_auto_year=2017&min_auto_year=1997&query=honda%20accord'
...
while (nextpageflag == 0) :
    ...
    for mline in all:
        ...
        if re.search(mymodel, mytitle, flags=re.I) :
            print '+',
        else :
            wrongcount += 1
            if wrongcount > 10:
    ...
    with open("CAR_PRICE_TIME2.csv", "a") as csvfile:
